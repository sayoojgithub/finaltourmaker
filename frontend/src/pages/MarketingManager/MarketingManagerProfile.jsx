...
import AdsManagment from "./AdsManagment";
import CreativeStaffWorkManagement from "./CreativeStaffWorkManagement";
...
export default function MarketingManagerProfile() {
  ...
  //     case 4:
  //       return <DailyTaskRequest/>
  //     case 5:
  //       return <CreativeStaffWorkManagement/>
  //     case 6:
  //       return <DigitalMarketerWorkAnalysis/>
  //     default:
  //       return null;
  //   }
  // };
const renderTabContent = () => {
  switch (activeTab) {
    ...
    case 3:
      return <DigitalMarketerWorkAnalysis/>
    case 4:
      return <AllAssignedTaskManagement/>
    default:
      return null;
  }
}
