// src/components/DigitalMarketerAdTaskAnalysis/DigitalMarketerAdTaskAnalysis.jsx
...
export default function DigitalMarketerAdTaskAnalysis() {
  ...
  const fetchList = async (nextPage = page) => {
    try {
      setLoading(true);
      const res = await API.get(`/marketingManager/dm-ad-tasks?${buildQuery(nextPage)}`);
