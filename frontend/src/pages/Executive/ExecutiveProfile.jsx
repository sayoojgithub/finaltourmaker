...
const tabData = [{ label: "My Clients" }];
...
export default function ExecutiveProfile() {
  ...
  // Same behaviour as FrontOfficer: Esc closes drawer, body scroll freeze
  useEffect(() => {
    ...
    <div className="w-full max-w-[100rem] mx-auto bg-white rounded-3xl shadow-md p-6 md:p-8 mb-6 mt-6">
      ...
      <div className="flex items-center justify-between gap-4">
        <button
          ...
          aria-controls="executive-drawer"
        >
        ...
        {/* Spacer on the right to balance header */}
