...
export default function CustomTourItineraryModal({
  ...
  const handleReferralDownload = async () => {
    ...
    try {
      ...
      await API.post("/executive/custom-tour-referral-itinerary", {
        clientId: client._id,
        nextDateRaw: nextDate,
        nextTimeRaw: nextTime,
      });

      toast.success("Custom tour referral itinerary status saved");
  ...
  const handleConfirmDownload = async () => {
    try {
      ...
      await API.post("/executive/custom-tour-confirm-itinerary", {
        clientId: client._id,
        nextDateRaw: nextDate || null, // optional
        nextTimeRaw: nextTime || null, // optional
      });

      toast.success("Custom tour confirmed itinerary status saved");
          ...
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <div className="text-lg sm:text-xl font-bold text-slate-900 flex flex-wrap items-center gap-2">
                {/* later you can show custom tour name here */}
