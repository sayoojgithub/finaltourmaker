...
import CreativeUploadRequests from "./CreativeUploadRequests";
import AllTaskManagement from "./AllTaskManagement";
import AllMarketingManagerAssignedTask from "./AllMarketingManagerAssignedTask";
// const tabData = [
//   { label: "Ad Requests" },
//   { label: "Lead Requests" },
...
export default function CreativeStaffProfile() {
  ...
  //   switch (activeTab) {
  //     case 0:
  //       return <CreativeAdRequests/>
  //     case 1:
  //       return <CreativeLeadRequests/>
  //     case 2:
  //       return <CreativeUploadRequests/>
  //     case 3:
  //       return 
  //     case 4:
  //       return 
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      ...
      case 1:
        return <AllMarketingManagerAssignedTask/>
      default:
        return null;
    }
  }
